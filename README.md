...
Use of AI: Generative AI (ChagtGPT 4o) was used to generate the base code for API calls and to handle the creation and parsing of JSONs. Also used for debugging certain code blocks and as a spelling check and review tool for the report. 
