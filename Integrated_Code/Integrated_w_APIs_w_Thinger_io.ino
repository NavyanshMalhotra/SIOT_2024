...
void sendPostRequest() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // JSON payload
    String jsonData = "{\"batteryVoltage\":battery_voltage,\"L_PIR\":left_PIR,\"R_PIR\":right_PIR,\"motion\":motion,\"Lat\":coords[0],\"Lng\":coords[1],\"Is_Day_Time\":is_DayTime,\"Is_Dark\":is_dark,\"Yaw\":ypr_filtered[0],\"Pitch\":ypr_filtered[1],\"Roll\":ypr_filtered[2]}";
